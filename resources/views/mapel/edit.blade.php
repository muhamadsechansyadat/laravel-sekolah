        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ url('mapel/update/'.$data->id) }}" method="post" id="create" enctype="multipart/form-data">
                        @if(session('message'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Matematika" value="{{ $data->nama }}" required>
                        </div>
                        <div class="form-group">
